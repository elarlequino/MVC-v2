...
<form class="d-inline-block" method="POST" action="/backoffice/create">
    <fieldset>
        <legend>Créer une nouvelle categorie</legend>
...
<?php foreach ($categories as $item): ?>
    <div>
        <form class="d-inline-block" method="POST" action="/backoffice/update/<?= $item['idCategories'] ?>">
            <fieldset>
        ...
        <a href="/backoffice/delete/<?= $item['idCategories'] ?>">
